      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
            ...
            <span className="block text-primary-600">Appointment Booking</span>
          </h1>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            The booking infrastructure that agencies can brand, resell, and monetize.
            Launch your own booking software in days instead of months.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
            ...
            <p className="text-gray-500">Your logo, your colors, your domain. Complete customization for each agency.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
            ...
            <p className="text-gray-500">Seamless Google Calendar sync. Prevent double bookings automatically.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
            ...
            <p className="text-gray-500">Manage unlimited clients from a single dashboard. Complete data isolation.</p>
          </div>
        </div>
      </div>
